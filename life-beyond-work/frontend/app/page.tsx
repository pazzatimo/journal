    ...
    <div className="container" style={{ paddingBottom: '4rem' }}>
      ...
      <section className="hero-section">
        ...
        <div className="hero-content">
          ...
          <div>
            {featuredArticle && (
              <Link href={`/articles/${featuredArticle.slug?.current}`} className="hero-cta">
              ...
              <Link key={item._id} href={item.link} style={{ textDecoration: 'none' }}>
                <div className="grid-card" style={{ height: '100%', position: 'relative' }}>
                  ...
                  <div style={{ padding: '1rem' }}>
                    ...
                    {item.authorName && <p style={{ color: '#6b7280', fontSize: '0.75rem' }}>by {item.authorName}</p>}
                    {item.rating && <p style={{ color: '#d97706', fontSize: '0.8rem' }}>★ {item.rating}/5</p>}
              ...
              <Link key={book._id} href={`/books/${book.slug?.current}`} style={{ textDecoration: 'none' }}>
                <div className="grid-card" style={{ height: '100%', textAlign: 'center', position: 'relative' }}>
                  ...
                  <div style={{ padding: '0.75rem' }}>
                    ...
                    {book.rating && <p style={{ color: '#d97706', fontSize: '0.8rem' }}>★ {book.rating}/5</p>}
                  </div>
                </div>
              </Link>
            ))
