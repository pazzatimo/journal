  ...
  return (
    <div style={{ maxWidth: '720px', margin: '0 auto', padding: '2rem 2rem 4rem 2rem' }}>
      <article>
        ...
        {item.thumbnail && (
          <div style={{ position: 'relative', height: '320px', borderRadius: '0.75rem', overflow: 'hidden', marginBottom: '2rem', backgroundColor: '#f3f4f6' }}>
        ...
        <header style={{ marginBottom: '2rem' }}>
          ...
          {item.description && (
            <p style={{ fontSize: '1.1rem', color: '#4b5563', marginBottom: '1rem' }}>
              {item.description}
            </p>
          )}
          {item.publishedAt && (
        ...
        {item.lyrics && isAudio && (
          <div style={{ marginBottom: '2rem' }}>
            <h2 style={{ fontSize: '1.3rem', fontWeight: '400', color: '#1a1a1a', marginBottom: '0.5rem' }}>
              Lyrics
            </h2>
            <div style={{
              backgroundColor: '#f9fafb',
