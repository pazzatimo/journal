      ...
      {isAIAlbum && total > 0 && (
        <div style={{
          ...
          <p style={{
            ...
            Nyimbo hizi zimetungwa na binadamu (kutoka wenye Biblia Takatifu na Nukuu za Ndg William Branham), lakini mchanganyiko wa sauti na vyombo vya muziki umefanywa kwa msaada wa Akili Mnemba (AI).
            <span style={{ display: 'block', fontSize: '0.8rem', color: '#9ca3af', marginTop: '0.25rem' }}>
              These songs are composed by humans, (From the holly Bible and Bro. William Branham's Quotes ) with AI‑assisted audio mixing and instrumentation.
            </span>
          </p>
        </div>
      )}
